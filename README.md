...
[![Release](https://img.shields.io/badge/release-download-brightgreen.svg)](https://github.com/Yunnijian/Xiaomi_FanUltra/releases/tag/v1.0.2)
...
<p>
  <a href="https://github.com/Yunnijian/Xiaomi_FanUltra/releases/tag/v1.0.2"><strong>下载 Release</strong></a>
  ·
...
| 项目 | 地址 |
|---|---|
| GitHub Release | [Xiaomi FanUltra v1.0.2](https://github.com/Yunnijian/Xiaomi_FanUltra/releases/tag/v1.0.2) |
| APK 文件 | [MifanUltra1.0.2-release.apk](https://github.com/Yunnijian/Xiaomi_FanUltra/releases/download/v1.0.2/MifanUltra1.0.2-release.apk) |
...
- 开启“息屏时保持风扇开启”后，屏蔽官方息屏停转分支，并在部分场景使用/游戏息屏时保留最近一次官方正档位。
...
从 [Release 页面](https://github.com/Yunnijian/Xiaomi_FanUltra/releases/tag/v1.0.2) 下载并安装：

```txt
MifanUltra1.0.2-release.apk
```
...
mkdir -p dist
cp -f app/build/outputs/apk/release/app-release.apk dist/MifanUltra1.0.2-release.apk
```
